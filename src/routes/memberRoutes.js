...
const { requireMember, requireActiveMembership } = require('../middleware/roles');
...
router.post('/attendance/checkin', requireActiveMembership, markAttendanceValidator, validateRequest, attendanceController.memberCheckIn);

// Body weight tracking
router.get('/weight', weightController.showWeightPage);
router.post('/weight/log', requireActiveMembership, logWeightValidator, validateRequest, weightController.logWeight);
router.post('/weight/:id/delete', requireActiveMembership, weightController.deleteWeight);
